import{a as C}from"./chunk-Q44VOGOY.js";import{C as s,Da as g,Ea as f,Kc as x,S as l,T as p,U as u,X as i,Zb as y,a as o,fb as v,gb as h,n as c,qb as b,y as m}from"./chunk-XB6BERNY.js";var k=["*"];var S=new u("MAT_CARD_CONFIG"),B=(()=>{class a{appearance;constructor(){let e=i(S,{optional:!0});this.appearance=e?.appearance||"raised"}static \u0275fac=function(t){return new(t||a)};static \u0275cmp=g({type:a,selectors:[["mat-card"]],hostAttrs:[1,"mat-mdc-card","mdc-card"],hostVars:8,hostBindings:function(t,r){t&2&&b("mat-mdc-card-outlined",r.appearance==="outlined")("mdc-card--outlined",r.appearance==="outlined")("mat-mdc-card-filled",r.appearance==="filled")("mdc-card--filled",r.appearance==="filled")},inputs:{appearance:"appearance"},exportAs:["matCard"],ngContentSelectors:k,decls:1,vars:0,template:function(t,r){t&1&&(v(),h(0))},styles:[`.mat-mdc-card {
  display: flex;
